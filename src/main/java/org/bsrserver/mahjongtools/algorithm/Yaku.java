...
public class Yaku {
    ...
    public static final Yaku LAST_TILE_FROM_THE_WALL            = new Yaku("海底摸月",1);
    public static final Yaku LAST_DISCARD                       = new Yaku("河底捞鱼",1);
    ...
    public static final Yaku NAGASHI_MANGAN                     = new Yaku("流局满贯",5);
    ...
    public static final Yaku TWO_SETS_OF_IDENTICAL_SEQUENCES    = new Yaku("两杯口",1);
